...
const InternalImportRequestPage = () => {
        ...
        <>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={3}>
                <Typography variant="h4" gutterBottom>
                    Quản lý phiếu yêu cầu nhập kho nội bộ
                </Typography>
                <Button
                    variant="contained"
                    startIcon={<Iconify icon="eva:plus-fill" />}
                    onClick={() => navigate('/dashboard/create-internal-import-request')}
                >
                    Tạo phiếu yêu cầu nhập kho nội bộ
                </Button>
...
export default InternalImportRequestPage;
